...
This project is indexed by GitNexus as **WinFaceUnlock** (7010 symbols, 15471 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
