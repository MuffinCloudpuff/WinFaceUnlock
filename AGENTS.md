...
This project is indexed by GitNexus as **WinFaceUnlock** (7030 symbols, 15506 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
